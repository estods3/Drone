...
#define MAX_PULSE_LENGTH 1960 // Maximum pulse length in µs
// ---------------------------------------------------------------------------
...
void setup() {
    ...
    motA.attach(D5, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH); //NOTE: use "5" for arduino and "D5" for NodeMCU
    Serial.print("attached");
    //motB.attach(6, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    //motC.attach(8, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    //motD.attach(0, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
